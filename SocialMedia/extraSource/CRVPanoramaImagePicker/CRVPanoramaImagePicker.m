...
{    
    ...
    toolBar = [[UIToolbar alloc] initWithFrame:CGRectMake(0, 0, scrollViewContentSize.width, 60)];
    
    UIBarButtonItem *title = [[UIBarButtonItem alloc] initWithTitle:@"Panoramic"
